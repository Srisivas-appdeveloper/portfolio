...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'React Native',image: 'assets/icons/reactnative.png',),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Javascript',image: 'assets/icons/js.png',),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Flutter',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Dart',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Firebase',image: 'assets/icons/firebase.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Sqlite',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'MVVM Architecture',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.63, title: 'Getx',image: 'assets/icons/dart.png'),
      ],);
  }
}
